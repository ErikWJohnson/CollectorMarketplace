...
const tradePaymentOptions = ['Instant Bank Transfer', 'Wire Transfer'];
...
function feeCalculator(item, type) {
  ...
  const paymentMethods = [['Instant Bank Transfer', 'FedNow or RTP · available 24/7'], ['Wire Transfer', 'Bank wire · best for high-value orders']];
