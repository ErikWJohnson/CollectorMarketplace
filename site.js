...
const ensurePublicListingLocation = () => {
  ...
  fulfillmentField.innerHTML = '<legend>Fulfillment <i>Required</i></legend><div><label><input required type="radio" name="fulfillment" value="pickup"> Pickup</label><label><input type="radio" name="fulfillment" value="delivery"> Delivery</label><label><input type="radio" name="fulfillment" value="both"> Pickup &amp; delivery</label></div><small>Pickup details are shared privately only after an order is confirmed.</small>';
...
const card = item => {
  ...
  const fulfillmentLabel = { pickup: 'PICKUP', delivery: 'DELIVERY', both: 'PICKUP & DELIVERY' }[item.fulfillment] || 'DELIVERY';
