...
const tradePaymentOptions = ['FedNow', 'RTP', 'Wire transfer'];
...
function feeCalculator(item, type) {
  ...
  const paymentMethods = [['FedNow', 'Instant bank payment · 24/7'], ['RTP', 'Real-time bank payment · 24/7'], ['Wire transfer', 'Bank wire · best for high-value orders']];
