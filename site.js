...
function syncBrowseModeUi() {
  ...
  if (conveyor && !orbit) { orbit = document.createElement('div'); orbit.className = 'conveyor-orbit-layer'; orbit.setAttribute('aria-hidden', 'true'); orbit.innerHTML = '<i></i><i></i><i></i><b class="conveyor-earth"><em></em><em></em></b>'; document.querySelector('.app-shell')?.prepend(orbit); }
