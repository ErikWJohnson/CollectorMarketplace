...
function syncBrowseModeUi() {
  ...
  if (conveyor && !orbit) { orbit = document.createElement('div'); orbit.className = 'conveyor-orbit-layer'; orbit.setAttribute('aria-hidden', 'true'); document.querySelector('.app-shell')?.prepend(orbit); }
