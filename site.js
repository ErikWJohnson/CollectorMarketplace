...
const card = item => {
  ...
  const desktopTextSpace = Math.min(530, 190 + Math.ceil(textLength / 72) * 18); const mobileTextSpace = Math.min(505, 195 + Math.ceil(textLength / 32) * 16);
  ...
  const desktopDescriptionSize = Math.max(6, Math.min(11.5, (desktopTextSpace - 175) / (desktopLines * 1.35))); const mobileDescriptionSize = Math.max(4.2, Math.min(11.5, (mobileTextSpace - 195) / (mobileLines * 1.32)));
