...
openListingForm = () => { openListingModal(); const markup = modalContent.innerHTML; restoringWorkspaceHistory = true; modal.close(); restoringWorkspaceHistory = false; openAppSection('listing', 'Create a listing', 'Build a complete collector-ready listing with media, delivery details, and a saved draft.', markup); document.body.classList.add('listing-page'); };
