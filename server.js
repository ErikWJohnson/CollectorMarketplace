...
const rootSiteAssets = new Set([
  ...
  'listing-sort.css', 'delivery-workspace.css', 'app-performance.css', 'account-connections.css', 'social-chat.css', 'jungle-chat.css', 'account-venice.css', 'voice-chat.css', 'account-workspace.css', 'tags-expanded.css', 'professional-ui.css', 'workspace-scrolling.css', 'scroll-stability.css', 'page-scroll-fixes.css', 'listing-form-refined.css', 'lobby-song.css', 'site-theme.css', 'conveyor-smog.css', 'favicon.png', 'favicon-512.png', 'sitemap.xml', 'robots.txt', 'BingSiteAuth.xml'
]);
